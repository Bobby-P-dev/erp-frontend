...
<template>
    <div class="relative w-full" ref="containerRef">
        ...
        <div 
            ...
            class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm flex items-center justify-between cursor-pointer transition-all hover:bg-white focus:bg-white min-h-[46px]"
        ...
        >
            ...
            <div class="max-h-60 overflow-y-auto p-1">
                ...
                <div 
                    ...
                    :class="modelValue.includes(option.value) ? 'bg-indigo-50 text-indigo-700 font-bold' : 'text-gray-700 hover:bg-gray-50'"
                >
                    <span>{{ option.label }}</span>
                    <Check v-if="modelValue.includes(option.value)" class="w-4 h-4 text-indigo-600" />
                </div>
            </div>
        </div>
    </div>
